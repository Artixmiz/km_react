...
import React, { Lazy, Suspense, useRef, FC } from "react";
                              ...
                              uslink.map((v) => v.user_idcard) ? (
                                <p>
                                  ...
                                  <Button>
                                    <a
                                      target="_blank"
                                      href={uslink.map((v) => v.link_url)}
                                      rel="noreferrer"
                                    >
                                      {uslink.map((v) => v.link_name)}
                                      {/* {scholar.map((v) => v.GG_URL).slice(-15)}{" "} */}
                                    </a>
                                  </Button>
                                </p>
                        ...
                        {projecttype1.map((l, i) => {
                          ...
                          return (
                            <tr>
                              ...
                              <td>
                                {l.project_type_id == 2 ? <FaCheck /> : ""}
                              </td>
                              <td>
                                {l.project_type_id == 5 ? <FaCheck /> : ""}
                              </td>
                            </tr>
                          );
                        })}
                                ...
                                {course.map((listValue, index) => {
                                  return (
                                    <CardText>
                                      ...
                                      <p>
                                        ระดับการศึกษา : {listValue.degnameth}
                                      </p>
